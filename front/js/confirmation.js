...
let respuesta = document.getElementById('orderId');            /*récupération de l'id ou afficher la commander sur la page/*/
respuesta.textContent = id;                               /*définisent le texte en tant que id y est = à le numéro de commander */